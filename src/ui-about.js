      ...
      <article class="about-page">
        ...
        <section class="about-section" data-about-section="stats" aria-label="Chess site statistics">
          <div class="about-stats-grid">
            <article class="about-stat-card"><span class="about-stat-value">76</span><span class="about-stat-label">Unit suites run</span><span class="about-stat-detail">In the full unit check</span></article>
