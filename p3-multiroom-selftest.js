...
async function runTests() {
  ...
  try {
    ...
    const resSubAsset = await httpGet(server, '/game/room-alpha/engine.js');
    assert(resSubAsset.status === 200, 'GET /game/room-alpha/engine.js serves engine.js asset');
    ...
    const uiSource = fs.readFileSync(path.join(DIR, 'ui.js'), 'utf8');
