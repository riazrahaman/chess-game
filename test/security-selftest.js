...
async function runSecurityTests() {
  ...
  try {
    ...
    execFileSync('node', [path.join(DIR, '..', 'src', 'referee-helper.cjs'), 'reset'], { cwd: DIR, env: process.env });
    ...
    const allowedFiles = [
      ...
      { path: '/src/engine.js', expectedStatus: 200, expectedMime: 'application/javascript' },
      { path: '/src/ui.js', expectedStatus: 200, expectedMime: 'application/javascript' },
      { path: '/src/pieces.js', expectedStatus: 200, expectedMime: 'application/javascript' },
    ];
