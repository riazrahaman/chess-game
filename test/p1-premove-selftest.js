...
function createHarness() {
  ...
  // B27: the harness window needs event registration (src/ui.js registers
  // pointer listeners at load) and a seeded seat store, so load-time
  // initSeatAuth() adopts the seat and the first move never auto-claims a
  // seat fetch that would consume the pending /api/move fetch stub.
