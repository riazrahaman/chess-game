...
const { sanToNaturalSpeech, parseSpokenMove, AccessibilityVoiceController } = require('../src/accessibility-voice.js');
...
assert.ok(html.includes('src="src/accessibility-voice.js"'), 'index.html must include accessibility-voice.js script');
